...
SELECT c.customer_id, c.customer_name,c.customer_city, SUM(p.unit_price * oi.quantity) AS total_order_value
FROM customers c
...
SELECT s.sales_rep_id, s.sales_rep_name, COUNT(DISTINCT o.customer_id) AS unique_customers_handled
