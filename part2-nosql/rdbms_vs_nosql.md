...
In healthcare system patient data is highly sensitive, require strong consistency for tracking, reliability and can be transactional. So considering this I recommend to use RDBMS (MySQL), as RDBMS follows ACID properties & helpful to fullfill above mentioned requirements for healthcare startup patient management system.
On the other hand MongoDB follows BASE properties which prefer high volume & flexibility instead of consistency so not suitable for patient management system.
